import { State as RootState } from '@branding/rootstate/index';
import { reducer as productReducer, State as fromProductState } from './products';
...
export declare const reducers: {
    products: typeof productReducer;
};
/**
